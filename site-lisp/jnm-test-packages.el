...
(setq jnm-package-table
      '(
        ...
        (nil                  "site-lisp/site-start.d/auctex.el" "http://www.gnu.org/software/auctex/download.html")                
        (nil                  "cdlatex.el"              "http://remote.science.uva.nl/~dominik/Tools/cdlatex/cdlatex.el")
        ))

(defun jnm-missing-packages (package-table)
  "Return packages that cannot be loaded"
  (remove-if
   (lambda (package-table-row)
     (apply
